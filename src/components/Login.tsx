...
function LoginForm() {
  ...
  return (
    <div className='flex flex-col gap-10 bg-white py-7 px-10 text-[#FFFFF2] rounded-xl min-w-[500px] main-shadow'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-7'>
        ...
        <p
          className={wrongCredentials ? 'text-red-500' : 'text-red-500 hidden'}
        >
