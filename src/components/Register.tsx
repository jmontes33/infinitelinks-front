...
function RegisterForm() {
  ...
  return (
    <>
      <div className='md:flex hidden flex-col gap-10 bg-white main-shadow py-7 px-10 text-[#FFFFF2] rounded-xl min-w-[500px]'>
      ...
      <div className='flex md:hidden flex-col gap-10 bg-white main-shadow py-7 px-10 text-[#FFFFF2] rounded-xl'>
        <div className='flex flex-col gap-3'>
          <h2 className='text-2xl text-black '>Welcome!</h2>
          <div className='flex flex-col gap-2 text-black '>
            <h2 className='text-3xl'>Sign Up to</h2>
